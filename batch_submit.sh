...
cmake .. -DArrayFire_DIR=/private/home/padentomasello/usr/share/ArrayFire/cmake -DCMAKE_BUILD_TYPE=Debug -DAF_BUILD_OPENCL=OFF -DAF_BUILD_CPU=OFF -DCUDA_architecture_build_targets="7.0;7.0+PTX;"   -DCMAKE_INSTALL_PREFIX=$HOME/usr -DcuDNN_LINK_LIBRARY=$CUDNN_LIB_DIR/libcudnn.so.7.6.2  -DcuDNN_INCLUDE_DIRS=$CUDNN_INCLUDE_DIR -DFL_LIBRARIES_USE_KENLM=OFF -DFL_BUILD_ALL_APPS=ON  -DFL_BUILD_EXAMPLES=ON -DBUILD_SHARED_LIBS=OFF
