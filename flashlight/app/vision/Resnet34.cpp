...
#include "flashlight/app/vision/dataset/ImagenetUtils.h"
#include "flashlight/app/vision/models/Resnet.h"
...
DEFINE_uint64(epochs, 150, "Epochs");
DEFINE_int64(
    world_rank,
    0,
...
std::tuple<double, double, double> eval_loop(
  ...
  TopKMeter top5_meter(5);
  TopKMeter top1_meter(1);
